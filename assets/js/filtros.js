    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            buttonText: function(options, select) {
                if (options.length === 0) {
                    return '<strong>FILTER LABEL:</strong> <br />' + this.nonSelectedText + ' <b class="caret"></b>';
                }
                else if (options.length == $('option', $(select)).length) {
                    return '<strong>FILTER LABEL:</strong> <br />' + this.allSelectedText + ' <b class="caret"></b>';
                }
                else if (options.length > this.numberDisplayed) {
                    return '<strong>FILTER LABEL:</strong> <br />' + options.length + this.nSelectedText + ' <b class="caret"></b>';
                }
                else {
                    var selected = '';
                    ...
                    return '<strong>FILTER LABEL:</strong> ' + selected.substr(0, selected.length - 2) + ' <b class="caret"></b>';
                }
            },
            /**
            ...
            templates: {
                button: '<button type="button" class="text-left multiselect dropdown-toggle" data-toggle="dropdown"></button>',
...
/* Danielle - Initialise multiselect plugin */
